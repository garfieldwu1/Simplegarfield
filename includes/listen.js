...
(async function () {
  ...
  if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
    ...
    if (event.body && event.body == `${prefix}request`) {
      ...
      return api.sendMessage(`Your Request Has Been Successfully Sent To The Admins, Please comment [ Approve ] for approval.\n\nFor approval: www.facebook.com/100027399343135/posts/1373465493576749/?app=fbl`, event.threadID);
    }
